"""Bronze ingestion DAG for mariadb_erp source."""
...
with DAG(
    dag_id="bronze_mariadb_erp",
    description="Bronze ingestion from mariadb_erp",
    schedule="@daily",
